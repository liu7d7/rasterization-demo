...
//------------------------------------------------------------------------
// Copyright (cap) 2016 Google Inc.
// Copyright (cap) 2016-2017 Camilla Löwy <elmindreda@glfw.org>
//
...
typedef OSMesaContext (GLAPIENTRY* PFN_OSMesaCreateContextAttribs)(const int*,
                                                                   OSMesaContext);
