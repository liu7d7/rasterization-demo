...
static void
glad_gl_load_GL_VERSION_1_0(GLADuserptrloadfunc load, void* userptr) {
...
static void
glad_gl_load_GL_VERSION_1_1(GLADuserptrloadfunc load, void* userptr) {
  if (!GLAD_GL_VERSION_1_1) return;
  glAreTexturesResident = (PFNGLARETEXTURESRESIDENTPROC)load(
    "glAreTexturesResident", userptr);
  ...
  glDisableClientState = (PFNGLDISABLECLIENTSTATEPROC)load(
    "glDisableClientState", userptr);
  ...
  glPopClientAttrib = (PFNGLPOPCLIENTATTRIBPROC)load("glPopClientAttrib",
                                                     userptr);
  glPrioritizeTextures = (PFNGLPRIORITIZETEXTURESPROC)load(
    "glPrioritizeTextures", userptr);
...
static void
glad_gl_load_GL_VERSION_1_2(GLADuserptrloadfunc load, void* userptr) {
...
static void
glad_gl_load_GL_VERSION_1_3(GLADuserptrloadfunc load, void* userptr) {
  if (!GLAD_GL_VERSION_1_3) return;
  glActiveTexture = (PFNGLACTIVETEXTUREPROC)load("glActiveTexture", userptr);
  glClientActiveTexture = (PFNGLCLIENTACTIVETEXTUREPROC)load(
    "glClientActiveTexture", userptr);
  glCompressedTexImage1D = (PFNGLCOMPRESSEDTEXIMAGE1DPROC)load(
    "glCompressedTexImage1D", userptr);
  glCompressedTexImage2D = (PFNGLCOMPRESSEDTEXIMAGE2DPROC)load(
    "glCompressedTexImage2D", userptr);
  glCompressedTexImage3D = (PFNGLCOMPRESSEDTEXIMAGE3DPROC)load(
    "glCompressedTexImage3D", userptr);
  ...
  glGetCompressedTexImage = (PFNGLGETCOMPRESSEDTEXIMAGEPROC)load(
    "glGetCompressedTexImage", userptr);
  glLoadTransposeMatrixd = (PFNGLLOADTRANSPOSEMATRIXDPROC)load(
    "glLoadTransposeMatrixd", userptr);
  glLoadTransposeMatrixf = (PFNGLLOADTRANSPOSEMATRIXFPROC)load(
    "glLoadTransposeMatrixf", userptr);
  glMultTransposeMatrixd = (PFNGLMULTTRANSPOSEMATRIXDPROC)load(
    "glMultTransposeMatrixd", userptr);
  glMultTransposeMatrixf = (PFNGLMULTTRANSPOSEMATRIXFPROC)load(
    "glMultTransposeMatrixf", userptr);
...
static void
glad_gl_load_GL_VERSION_1_4(GLADuserptrloadfunc load, void* userptr) {
  ...
  glSecondaryColor3ub = (PFNGLSECONDARYCOLOR3UBPROC)load("glSecondaryColor3ub",
                                                         userptr);
  glSecondaryColor3ubv = (PFNGLSECONDARYCOLOR3UBVPROC)load(
    "glSecondaryColor3ubv", userptr);
  glSecondaryColor3ui = (PFNGLSECONDARYCOLOR3UIPROC)load("glSecondaryColor3ui",
                                                         userptr);
  glSecondaryColor3uiv = (PFNGLSECONDARYCOLOR3UIVPROC)load(
    "glSecondaryColor3uiv", userptr);
  glSecondaryColor3us = (PFNGLSECONDARYCOLOR3USPROC)load("glSecondaryColor3us",
                                                         userptr);
  glSecondaryColor3usv = (PFNGLSECONDARYCOLOR3USVPROC)load(
    "glSecondaryColor3usv", userptr);
  glSecondaryColorPointer = (PFNGLSECONDARYCOLORPOINTERPROC)load(
    "glSecondaryColorPointer", userptr);
...
static void
glad_gl_load_GL_VERSION_1_5(GLADuserptrloadfunc load, void* userptr) {
  ...
  glGetBufferParameteriv = (PFNGLGETBUFFERPARAMETERIVPROC)load(
    "glGetBufferParameteriv", userptr);
...
static void
glad_gl_load_GL_VERSION_2_0(GLADuserptrloadfunc load, void* userptr) {
  if (!GLAD_GL_VERSION_2_0) return;
  glAttachShader = (PFNGLATTACHSHADERPROC)load("glAttachShader", userptr);
  glBindAttribLocation = (PFNGLBINDATTRIBLOCATIONPROC)load(
    "glBindAttribLocation", userptr);
  glBlendEquationSeparate = (PFNGLBLENDEQUATIONSEPARATEPROC)load(
    "glBlendEquationSeparate", userptr);
  ...
  glGetActiveUniform = (PFNGLGETACTIVEUNIFORMPROC)load("glGetActiveUniform",
                                                       userptr);
  glGetAttachedShaders = (PFNGLGETATTACHEDSHADERSPROC)load(
    "glGetAttachedShaders", userptr);
  ...
  glGetUniformLocation = (PFNGLGETUNIFORMLOCATIONPROC)load(
    "glGetUniformLocation", userptr);
  ...
  glStencilFuncSeparate = (PFNGLSTENCILFUNCSEPARATEPROC)load(
    "glStencilFuncSeparate", userptr);
  glStencilMaskSeparate = (PFNGLSTENCILMASKSEPARATEPROC)load(
    "glStencilMaskSeparate", userptr);
  ...
  glUniform2iv = (PFNGLUNIFORM2IVPROC)load("gl_uniform_2iv", userptr);
  ...
  glVertexAttrib4usv = (PFNGLVERTEXATTRIB4USVPROC)load("glVertexAttrib4usv",
                                                       userptr);
  glVertexAttribPointer = (PFNGLVERTEXATTRIBPOINTERPROC)load(
    "glVertexAttribPointer", userptr);
}

static void
glad_gl_load_GL_VERSION_2_1(GLADuserptrloadfunc load, void* userptr) {
  if (!GLAD_GL_VERSION_2_1) return;
  glUniformMatrix2x3fv = (PFNGLUNIFORMMATRIX2X3FVPROC)load(
    "glUniformMatrix2x3fv", userptr);
  glUniformMatrix2x4fv = (PFNGLUNIFORMMATRIX2X4FVPROC)load(
    "glUniformMatrix2x4fv", userptr);
  glUniformMatrix3x2fv = (PFNGLUNIFORMMATRIX3X2FVPROC)load(
    "glUniformMatrix3x2fv", userptr);
  glUniformMatrix3x4fv = (PFNGLUNIFORMMATRIX3X4FVPROC)load(
    "glUniformMatrix3x4fv", userptr);
  glUniformMatrix4x2fv = (PFNGLUNIFORMMATRIX4X2FVPROC)load(
    "glUniformMatrix4x2fv", userptr);
  glUniformMatrix4x3fv = (PFNGLUNIFORMMATRIX4X3FVPROC)load(
    "glUniformMatrix4x3fv", userptr);
}

static void
glad_gl_load_GL_VERSION_3_0(GLADuserptrloadfunc load, void* userptr) {
  ...
  glBindBufferRange = (PFNGLBINDBUFFERRANGEPROC)load("glBindBufferRange",
                                                     userptr);
  glBindFragDataLocation = (PFNGLBINDFRAGDATALOCATIONPROC)load(
    "glBindFragDataLocation", userptr);
  ...
  glDeleteFramebuffers = (PFNGLDELETEFRAMEBUFFERSPROC)load(
    "glDeleteFramebuffers", userptr);
  glDeleteRenderbuffers = (PFNGLDELETERENDERBUFFERSPROC)load(
    "glDeleteRenderbuffers", userptr);
  glDeleteVertexArrays = (PFNGLDELETEVERTEXARRAYSPROC)load(
    "glDeleteVertexArrays", userptr);
  glDisablei = (PFNGLDISABLEIPROC)load("glDisablei", userptr);
  glEnablei = (PFNGLENABLEIPROC)load("glEnablei", userptr);
  glEndConditionalRender = (PFNGLENDCONDITIONALRENDERPROC)load(
    "glEndConditionalRender", userptr);
  glEndTransformFeedback = (PFNGLENDTRANSFORMFEEDBACKPROC)load(
    "glEndTransformFeedback", userptr);
  ...
  glFramebufferTexture1D = (PFNGLFRAMEBUFFERTEXTURE1DPROC)load(
    "glFramebufferTexture1D", userptr);
  glFramebufferTexture2D = (PFNGLFRAMEBUFFERTEXTURE2DPROC)load(
    "glFramebufferTexture2D", userptr);
  glFramebufferTexture3D = (PFNGLFRAMEBUFFERTEXTURE3DPROC)load(
    "glFramebufferTexture3D", userptr);
  ...
  glGetFragDataLocation = (PFNGLGETFRAGDATALOCATIONPROC)load(
    "glGetFragDataLocation", userptr);
  ...
  glGetTexParameterIiv = (PFNGLGETTEXPARAMETERIIVPROC)load(
    "glGetTexParameterIiv", userptr);
  glGetTexParameterIuiv = (PFNGLGETTEXPARAMETERIUIVPROC)load(
    "glGetTexParameterIuiv", userptr);
  ...
  glGetVertexAttribIiv = (PFNGLGETVERTEXATTRIBIIVPROC)load(
    "glGetVertexAttribIiv", userptr);
  glGetVertexAttribIuiv = (PFNGLGETVERTEXATTRIBIUIVPROC)load(
    "glGetVertexAttribIuiv", userptr);
  ...
  glRenderbufferStorage = (PFNGLRENDERBUFFERSTORAGEPROC)load(
    "glRenderbufferStorage", userptr);
  ...
  glVertexAttribI4usv = (PFNGLVERTEXATTRIBI4USVPROC)load("glVertexAttribI4usv",
                                                         userptr);
  glVertexAttribIPointer = (PFNGLVERTEXATTRIBIPOINTERPROC)load(
    "glVertexAttribIPointer", userptr);
}

static void
glad_gl_load_GL_VERSION_3_1(GLADuserptrloadfunc load, void* userptr) {
  ...
  glCopyBufferSubData = (PFNGLCOPYBUFFERSUBDATAPROC)load("glCopyBufferSubData",
                                                         userptr);
  glDrawArraysInstanced = (PFNGLDRAWARRAYSINSTANCEDPROC)load(
    "glDrawArraysInstanced", userptr);
  glDrawElementsInstanced = (PFNGLDRAWELEMENTSINSTANCEDPROC)load(
    "glDrawElementsInstanced", userptr);
  ...
  glGetActiveUniformName = (PFNGLGETACTIVEUNIFORMNAMEPROC)load(
    "glGetActiveUniformName", userptr);
  glGetActiveUniformsiv = (PFNGLGETACTIVEUNIFORMSIVPROC)load(
    "glGetActiveUniformsiv", userptr);
  glGetIntegeri_v = (PFNGLGETINTEGERI_VPROC)load("glGetIntegeri_v", userptr);
  glGetUniformBlockIndex = (PFNGLGETUNIFORMBLOCKINDEXPROC)load(
    "glGetUniformBlockIndex", userptr);
  glGetUniformIndices = (PFNGLGETUNIFORMINDICESPROC)load("glGetUniformIndices",
                                                         userptr);
  glPrimitiveRestartIndex = (PFNGLPRIMITIVERESTARTINDEXPROC)load(
    "glPrimitiveRestartIndex", userptr);
  glTexBuffer = (PFNGLTEXBUFFERPROC)load("glTexBuffer", userptr);
  glUniformBlockBinding = (PFNGLUNIFORMBLOCKBINDINGPROC)load(
    "glUniformBlockBinding", userptr);
}

static void
glad_gl_load_GL_VERSION_3_2(GLADuserptrloadfunc load, void* userptr) {
  ...
  glFramebufferTexture = (PFNGLFRAMEBUFFERTEXTUREPROC)load(
    "glFramebufferTexture", userptr);
  ...
  glTexImage2DMultisample = (PFNGLTEXIMAGE2DMULTISAMPLEPROC)load(
    "glTexImage2DMultisample", userptr);
  glTexImage3DMultisample = (PFNGLTEXIMAGE3DMULTISAMPLEPROC)load(
    "glTexImage3DMultisample", userptr);
  glWaitSync = (PFNGLWAITSYNCPROC)load("glWaitSync", userptr);
}

static void
glad_gl_load_GL_VERSION_3_3(GLADuserptrloadfunc load, void* userptr) {
  ...
  glGetFragDataIndex = (PFNGLGETFRAGDATAINDEXPROC)load("glGetFragDataIndex",
                                                       userptr);
  glGetQueryObjecti64v = (PFNGLGETQUERYOBJECTI64VPROC)load(
    "glGetQueryObjecti64v", userptr);
  glGetQueryObjectui64v = (PFNGLGETQUERYOBJECTUI64VPROC)load(
    "glGetQueryObjectui64v", userptr);
  ...
  glGetSamplerParameterfv = (PFNGLGETSAMPLERPARAMETERFVPROC)load(
    "glGetSamplerParameterfv", userptr);
  glGetSamplerParameteriv = (PFNGLGETSAMPLERPARAMETERIVPROC)load(
    "glGetSamplerParameteriv", userptr);
  ...
  glMultiTexCoordP1ui = (PFNGLMULTITEXCOORDP1UIPROC)load("glMultiTexCoordP1ui",
                                                         userptr);
  glMultiTexCoordP1uiv = (PFNGLMULTITEXCOORDP1UIVPROC)load(
    "glMultiTexCoordP1uiv", userptr);
  glMultiTexCoordP2ui = (PFNGLMULTITEXCOORDP2UIPROC)load("glMultiTexCoordP2ui",
                                                         userptr);
  glMultiTexCoordP2uiv = (PFNGLMULTITEXCOORDP2UIVPROC)load(
    "glMultiTexCoordP2uiv", userptr);
  glMultiTexCoordP3ui = (PFNGLMULTITEXCOORDP3UIPROC)load("glMultiTexCoordP3ui",
                                                         userptr);
  glMultiTexCoordP3uiv = (PFNGLMULTITEXCOORDP3UIVPROC)load(
    "glMultiTexCoordP3uiv", userptr);
  glMultiTexCoordP4ui = (PFNGLMULTITEXCOORDP4UIPROC)load("glMultiTexCoordP4ui",
                                                         userptr);
  glMultiTexCoordP4uiv = (PFNGLMULTITEXCOORDP4UIVPROC)load(
    "glMultiTexCoordP4uiv", userptr);
  ...
  glSamplerParameterIiv = (PFNGLSAMPLERPARAMETERIIVPROC)load(
    "glSamplerParameterIiv", userptr);
  glSamplerParameterIuiv = (PFNGLSAMPLERPARAMETERIUIVPROC)load(
    "glSamplerParameterIuiv", userptr);
  glSamplerParameterf = (PFNGLSAMPLERPARAMETERFPROC)load("glSamplerParameterf",
                                                         userptr);
  glSamplerParameterfv = (PFNGLSAMPLERPARAMETERFVPROC)load(
    "glSamplerParameterfv", userptr);
  glSamplerParameteri = (PFNGLSAMPLERPARAMETERIPROC)load("glSamplerParameteri",
                                                         userptr);
  glSamplerParameteriv = (PFNGLSAMPLERPARAMETERIVPROC)load(
    "glSamplerParameteriv", userptr);
  glSecondaryColorP3ui = (PFNGLSECONDARYCOLORP3UIPROC)load(
    "glSecondaryColorP3ui", userptr);
  glSecondaryColorP3uiv = (PFNGLSECONDARYCOLORP3UIVPROC)load(
    "glSecondaryColorP3uiv", userptr);
  ...
  glVertexAttribDivisor = (PFNGLVERTEXATTRIBDIVISORPROC)load(
    "glVertexAttribDivisor", userptr);
...
static void
glad_gl_load_GL_ARB_multisample(GLADuserptrloadfunc load, void* userptr) {
...
static void
glad_gl_load_GL_ARB_robustness(GLADuserptrloadfunc load, void* userptr) {
  ...
  glGetnPixelMapfvARB = (PFNGLGETNPIXELMAPFVARBPROC)load("glGetnPixelMapfvARB",
                                                         userptr);
  glGetnPixelMapuivARB = (PFNGLGETNPIXELMAPUIVARBPROC)load(
    "glGetnPixelMapuivARB", userptr);
  glGetnPixelMapusvARB = (PFNGLGETNPIXELMAPUSVARBPROC)load(
    "glGetnPixelMapusvARB", userptr);
  glGetnPolygonStippleARB = (PFNGLGETNPOLYGONSTIPPLEARBPROC)load(
    "glGetnPolygonStippleARB", userptr);
...
static void glad_gl_load_GL_KHR_debug(GLADuserptrloadfunc load, void* userptr) {
  ...
  glDebugMessageCallback = (PFNGLDEBUGMESSAGECALLBACKPROC)load(
    "glDebugMessageCallback", userptr);
  glDebugMessageControl = (PFNGLDEBUGMESSAGECONTROLPROC)load(
    "glDebugMessageControl", userptr);
  glDebugMessageInsert = (PFNGLDEBUGMESSAGEINSERTPROC)load(
    "glDebugMessageInsert", userptr);
  glGetDebugMessageLog = (PFNGLGETDEBUGMESSAGELOGPROC)load(
    "glGetDebugMessageLog", userptr);
...
static int
glad_gl_has_extension(int version, const char* exts, unsigned int num_exts_i,
                      char** exts_i, const char* ext) {
...
static GLADapiproc
glad_gl_get_proc_from_userptr(const char* name, void* userptr) {
...
static int glad_gl_find_extensions_gl(int version) {
  ...
  GLAD_GL_KHR_debug = glad_gl_has_extension(version, exts, num_exts_i, exts_i,
                                            "GL_KHR_debug");
