...
// Finds a mapping based on joystick GUID and verifies element size
//
...
GLFWAPI void glfw_set_input_mode(GLFWwindow* win, int mode, int value) {
  _GLFWwindow* window = (_GLFWwindow*)win;
  assert(window != NULL);
...
GLFWAPI int glfw_get_key(GLFWwindow* win, int key) {
  _GLFWwindow* window = (_GLFWwindow*)win;
  assert(window != NULL);
...
GLFWAPI int glfw_get_mouse_button(GLFWwindow* handle, int button) {
  _GLFWwindow* window = (_GLFWwindow*)handle;
  assert(window != NULL);
...
GLFWAPI GLFWmousebuttonfun glfw_set_mouse_button_callback(GLFWwindow* handle,
...
GLFWAPI GLFWcursorposfun glfw_set_cursor_pos_callback(GLFWwindow* handle,
...
GLFWAPI GLFWcursorenterfun glfw_set_cursor_enter_callback(GLFWwindow* handle,
...
GLFWAPI GLFWscrollfun glfw_set_scroll_callback(GLFWwindow* handle,
                                               GLFWscrollfun cbfun) {
  _GLFWwindow* window = (_GLFWwindow*)handle;
  assert(window != NULL);
