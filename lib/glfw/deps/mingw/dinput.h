...
DECLARE_INTERFACE_(IDirectInputDeviceA, IUnknown) {
  ...
  STDMETHOD(EnumObjects)(THIS_ LPDIENUMDEVICEOBJECTSCALLBACKA lpCallback,
  ...
  STDMETHOD(GetDeviceData)(THIS_ DWORD cbObjectData, LPDIDEVICEOBJECTDATA rgdod,
                           LPDWORD pdwInOut, DWORD dwFlags) PURE;
  ...
  STDMETHOD(GetObjectInfo)(THIS_ LPDIDEVICEOBJECTINSTANCEA pdidoi, DWORD dwObj,
                           DWORD dwHow) PURE;
...
DECLARE_INTERFACE_(IDirectInputDeviceW, IUnknown) {
  ...
  STDMETHOD(EnumObjects)(THIS_ LPDIENUMDEVICEOBJECTSCALLBACKW lpCallback,
                         LPVOID pvRef, DWORD dwFlags) PURE;
  ...
  STDMETHOD(GetObjectInfo)(THIS_ LPDIDEVICEOBJECTINSTANCEW pdidoi, DWORD dwObj,
                           DWORD dwHow) PURE;
...
DECLARE_INTERFACE_(IDirectInputDevice2A, IDirectInputDeviceA) {
  ...
  STDMETHOD(CreateEffect)(THIS_ REFGUID rguid, LPCDIEFFECT lpeff,
                          LPDIRECTINPUTEFFECT* ppdeff,
                          LPUNKNOWN punkOuter) PURE;

  STDMETHOD(EnumEffects)(THIS_ LPDIENUMEFFECTSCALLBACKA lpCallback,
                         LPVOID pvRef, DWORD dwEffType) PURE;
  ...
  STDMETHOD(EnumCreatedEffectObjects)(THIS_
                                      LPDIENUMCREATEDEFFECTOBJECTSCALLBACK lpCallback,
                                      LPVOID pvRef, DWORD fl) PURE;

  STDMETHOD(Escape)(THIS_ LPDIEFFESCAPE pesc) PURE;

  STDMETHOD(Poll)(THIS) PURE;

  STDMETHOD(SendDeviceData)(THIS_ DWORD cbObjectData,
...
DECLARE_INTERFACE_(IDirectInputDevice2W, IDirectInputDeviceW) {
  ...
  STDMETHOD(EnumEffects)(THIS_ LPDIENUMEFFECTSCALLBACKW lpCallback,
                         LPVOID pvRef, DWORD dwEffType) PURE;
...
DECLARE_INTERFACE_(IDirectInputDevice7A, IDirectInputDevice2A) {
  ...
  STDMETHOD(EnumEffectsInFile)(THIS_ LPCSTR lpszFileName,
                               LPDIENUMEFFECTSINFILECALLBACK pec, LPVOID pvRef,
                               DWORD dwFlags) PURE;

  STDMETHOD(WriteEffectToFile)(THIS_ LPCSTR lpszFileName, DWORD dwEntries,
                               LPDIFILEEFFECT rgDiFileEft, DWORD dwFlags) PURE;
};
...
DECLARE_INTERFACE_(IDirectInputDevice7W, IDirectInputDevice2W) {
  ...
  STDMETHOD(EnumEffectsInFile)(THIS_ LPCWSTR lpszFileName,
                               LPDIENUMEFFECTSINFILECALLBACK pec, LPVOID pvRef,
                               DWORD dwFlags) PURE;

  STDMETHOD(WriteEffectToFile)(THIS_ LPCWSTR lpszFileName, DWORD dwEntries,
                               LPDIFILEEFFECT rgDiFileEft, DWORD dwFlags) PURE;
};
...
DECLARE_INTERFACE_(IDirectInputDevice8A, IDirectInputDevice7A) {
  ...
  STDMETHOD(BuildActionMap)(THIS_ LPDIACTIONFORMATA lpdiaf, LPCSTR lpszUserName,
                            DWORD dwFlags) PURE;

  STDMETHOD(SetActionMap)(THIS_ LPDIACTIONFORMATA lpdiaf, LPCSTR lpszUserName,
                          DWORD dwFlags) PURE;

  STDMETHOD(GetImageInfo)(THIS_
                          LPDIDEVICEIMAGEINFOHEADERA lpdiDevImageInfoHeader) PURE;
};
...
DECLARE_INTERFACE_(IDirectInputDevice8W, IDirectInputDevice7W) {
  ...
  STDMETHOD(BuildActionMap)(THIS_ LPDIACTIONFORMATW lpdiaf,
                            LPCWSTR lpszUserName, DWORD dwFlags) PURE;

  STDMETHOD(SetActionMap)(THIS_ LPDIACTIONFORMATW lpdiaf, LPCWSTR lpszUserName,
                          DWORD dwFlags) PURE;

  STDMETHOD(GetImageInfo)(THIS_
                          LPDIDEVICEIMAGEINFOHEADERW lpdiDevImageInfoHeader) PURE;
};
...
DECLARE_INTERFACE_(IDirectInputA, IUnknown) {
  ...
  STDMETHOD(CreateDevice)(THIS_ REFGUID rguid,
                          LPDIRECTINPUTDEVICEA* lplpDirectInputDevice,
                          LPUNKNOWN pUnkOuter) PURE;

  STDMETHOD(EnumDevices)(THIS_ DWORD dwDevType,
                         LPDIENUMDEVICESCALLBACKA lpCallback, LPVOID pvRef,
                         DWORD dwFlags) PURE;
...
DECLARE_INTERFACE_(IDirectInputW, IUnknown) {
  ...
  STDMETHOD(EnumDevices)(THIS_ DWORD dwDevType,
                         LPDIENUMDEVICESCALLBACKW lpCallback, LPVOID pvRef,
                         DWORD dwFlags) PURE;
...
DECLARE_INTERFACE_(IDirectInput2A, IDirectInputA) {
  ...
  STDMETHOD(FindDevice)(THIS_ REFGUID rguid, LPCSTR pszName,
                        LPGUID pguidInstance) PURE;
};
...
DECLARE_INTERFACE_(IDirectInput2W, IDirectInputW) {
  ...
  STDMETHOD(FindDevice)(THIS_ REFGUID rguid, LPCWSTR pszName,
                        LPGUID pguidInstance) PURE;
};
...
DECLARE_INTERFACE_(IDirectInput8A, IUnknown) {
  ...
  STDMETHOD(ConfigureDevices)(THIS_ LPDICONFIGUREDEVICESCALLBACK lpdiCallback,
                              ...
                              DWORD dwFlags, LPVOID pvRefData) PURE;
};
...
DECLARE_INTERFACE_(IDirectInput8W, IUnknown) {
  ...
  STDMETHOD(EnumDevicesBySemantics)(THIS_ LPCWSTR ptszUserName,
